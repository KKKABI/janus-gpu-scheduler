"""DRT on v2.1 worktree (janus_static_interference)"""
import os, sys
sys.path.insert(0, '/public_0/LYX/janus_static_interference')
sys.path.insert(0, os.path.dirname('/public_0/LYX/janus_static_interference'))
