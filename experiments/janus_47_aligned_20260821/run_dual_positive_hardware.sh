...
export JANUS_SIM_MANIFEST=/public_0/LYX/janus_47_aligned_outputs_20260821/dual_positive_sample_v2/manifest.json
export JANUS_SIM_VALIDATION_OUT=/public_0/LYX/janus_47_aligned_outputs_20260821/dual_positive_hardware_v2
